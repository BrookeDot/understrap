...
if (!class_exists('Understrap_WP_Bootstrap_Navwalker')) {
    ...
    class Understrap_WP_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            ...
            //Check if menu depth is greater then 2. This will add role of menu to sub-menu parent
            $menuRole = ($args->depth > 2) ? 'role="menu"' : '';

            $output .= "{$n}{$indent}<ul$class_names $labelledby $menuRole>{$n}";
        }
